...
| 自治体 | システム | 1日の枠 | 通知条件 |
|---|---|---|---|
| 青梅市 | P-kashikan | 6枠 (9-12/12-13/13-15/15-17/17-19/19-21) | 3枠以上連続、青梅市民センター 天ヶ瀬体育館の「全面」のみ |
| 江東区 | スポーツネット | 3枠 (9-12/13-17/18-21:30) | 2枠以上連続、ただし13:00-17:00は1枠でも通知。各施設の大体育室「全面」のみ(半面・小体育室は対象外) |
...
- `facility_filters`: 施設名にこの文字列を含む施設だけを対象にする(省略時は全施設。
  例: 江東区の `["全面"]` は各施設の大体育室全面だけ、青梅市の `["瀬体育館全面"]`
  は天ヶ瀬体育館の全面だけ)
- `facility_excludes`: 施設名にこの文字列を含む施設を対象から除外する
  (`facility_filters` と併用可。「この施設群のうち分割面だけ除く」のような
  絞り込み用)
